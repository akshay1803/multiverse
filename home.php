...
<a href="https://www.geeksforgeeks.org/" class="box">
        <img src="images/category-1.png" alt="">
        <h3>computer science</h3>
    </a>

    <a href="https://en.wikipedia.org/wiki/Biology" class="box">
        <img src="images/category-2.png" alt="">
        <h3>biology & life</h3>
    </a>

    <a href="https://www.tutorialspoint.com/business_analysis/index.htm" class="box">
        <img src="images/category-3.png" alt="">
        <h3>business analysis</h3>
    </a>

    <a href="https://www.britannica.com/topic/social-science" class="box">
        <img src="images/category-4.png" alt="">
        <h3>social science</h3>
    </a>

    <a href="https://www.coursera.org/articles/what-is-data-analysis-with-examples" class="box">
